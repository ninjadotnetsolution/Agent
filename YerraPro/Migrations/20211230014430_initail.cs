    ...
    public partial class initail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessesInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessesInfos_Agents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemInfos_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessesInfos_AgentId",
                table: "ProcessesInfos",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemInfos_AgentId",
                table: "SystemInfos",
                column: "AgentId",
                unique: true,
